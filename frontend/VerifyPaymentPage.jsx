...
const VerifyPaymentPage = () => {
    const [statusMsg,setStatusMsg]=useState('Verifyning Payment...');
    ...
    <div className='min-h-screen flex items-center justify-center text-white p-4'>
     <div className='text-center max-w-lg'>
       ...
       <p className='text-sm opacity-70'>
        If this page shows "session not found" , try copying the `session_id` from your browser
        URL and verify it with your backend logs or contact support.
       </p>
     </div>
    </div>
  )
