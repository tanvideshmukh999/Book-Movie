...
import { moviesPageStyles, moviesStyles } from '../assets/frontend/dummyStyles'
            ...
            <div className={moviesPageStyles.moviesContainer}>
                {loading ? (
                    ...
                    {visibleMovies.map(movie=>(
                        <Link key={movie.id} to={`/movies/${movie.id}`} state={{movie}}  className={moviesPageStyles.movieCard}>
                            <div className={moviesPageStyles}>
                ...
                {filteredMovies.length > COLLAPSE_COUNT && (
                    <div className={moviesPageStyles.showMoreContainer}>
                        <button onClick={()=> setShowAll((prev)=>!prev)} className={moviesPageStyles.showMoreButton} type='button'>
                            {
