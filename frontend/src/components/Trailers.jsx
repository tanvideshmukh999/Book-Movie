...
// if the pic is present then ok else it will show the placeholder thumbnail
  if (firstDirector) {
    credits["Director"] = {
...
const Trailers = () => {
  ...
  //this function helps in  show the selected trailer
            ...
            <div className={trailersStyles.layout}>
               ...
               <div className={trailersStyles.leftSide}>
                <div className={trailersStyles.leftCard}>
                    <h2 className={trailersStyles.leftTitle} style={{fontFamily:"Monton ,cursive"}}>
                  ...
                  >
                    ...
                    <div className={trailersStyles.trendingSection}>
                        <h3 className={trailersStyles.trendingTitle}></h3>
