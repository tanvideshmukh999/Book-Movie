...
import { bookingsPageStyles,formatTime,formatDuration } from '../assets/frontend/dummyStyles'
  ...
  return (
    <div className={bookingsPageStyles.pageContainer}>
     <div className={bookingsPageStyles.mainContainer}>
      ...
      {loading && <div className={bookingsPageStyles.loading}>
        Loading Bookings...
        </div>}

        {!loading && error && 
        <div className={bookingsPageStyles.error}>
           {error}
          </div>}
