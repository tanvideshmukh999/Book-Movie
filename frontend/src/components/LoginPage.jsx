            ...
            <div className={loginStyles.cardContent}>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className={loginStyles.inputGroup}>
                        ...
                        <div className={loginStyles.inputContainer}>
                            <input type={showPassword ? 'text' :'password'} id="password" name="password" required value={formData.password} onChange={handleChange} className={loginStyles.inputWithIcon} placeholder=' Enter Your Password' />
                            <button type='button' className={loginStyles.passwordToggle}onClick={()=>setShowPassword(!showPassword)}>
                             {showPassword ? (
                                <EyeOff sixe ={18} className={loginStyles.passwordToggleIcon}/>
                             ) :(
                                <Eye sixe ={18} className={loginStyles.passwordToggleIcon}/>
                             )}
                            </button>
                        </div>
                    </div>
