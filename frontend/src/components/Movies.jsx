...
import { moviesStyles } from '../assets/frontend/dummyStyles'
import movies from '../assets/frontend/dummymoviedata.js'
...
const Movies = () => {
    const [movies,setMovies]=useState([]);
      ...
      useEffect(()=>{
        ...
        async function laodFeaturedMovies(){
            try {
        ...
        <div className='text-gray-400 py-12 text-center'>
          ...
          <div className={moviesStyles.grid}>
            ...
            <article key={movieId} className={moviesStyles.movieArticle}>
                ...
                <img src={imgSrc} alt={title} loading="lazy" className={moviesStyles.movieImage} onError={(e)=>{
                ...
                <div className={moviesStyles.movieInfo}>
                    <div className={moviesStyles.titleContainer}>
                        ...
                        <span id={`movie-title-${movieId}`} className={moviesStyles.movieTitle} style={{fontFamily:"'Pacifico' ,cursive"}} >
                            {title}
                        </span>
                    </div>
