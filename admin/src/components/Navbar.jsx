            ...
            <aside id="mobile-menu" className={`${styles4.mobileMenuPanel} ${open ? 'translate-x-0':'translate-x-full'}`} role="dialog">
              <div className={styles4.mobileMenuPanelHeader}>
                <div className={styles4.logoContainer}>
                  <div className="flex items-center justify-center w-10 h-10 bg-red-600 rounded-full transform rotate-12">
                    ...
                    <span className="font-['Impact'] text-xl text-white tracking-winder">
                      CINEVERSE
                    </span>
                </div>
              ...
              <nav className={styles4.mobileMenuPanelNav}>
                <NavLink to='/' end onClick={close} className={({isActive})=>`${styles4.mobileNavLinkBase} ${isActive ? styles4.mobileNavLinkActive : styles4.mobileNavLinkInactive}`}>
                  {({isActive})=>(
                    <>
                    <Film className={`${styles4.mobileNavLinkIconBase} ${isActive ?
                      styles4.mobileNavLinkIconInactive : styles4.mobileNavLinkIconInactive
                    }`}/>
                 ...
                 <NavLink to='/listmovies'  onClick={close} className={({isActive})=>`${styles4.mobileNavLinkBase} ${isActive ? styles4.mobileNavLinkActive : styles4.mobileNavLinkInactive}`}>
                  {({isActive})=>(
                    <>
                    <List className={`${styles4.mobileNavLinkIconBase} ${isActive ?
                      styles4.mobileNavLinkIconInactive : styles4.mobileNavLinkIconInactive
                    }`}/>
                 ...
                 <NavLink to='/dashboard' onClick={close} className={({isActive})=>`${styles4.mobileNavLinkBase} ${isActive ? styles4.mobileNavLinkActive : styles4.mobileNavLinkInactive}`}>
                  {({isActive})=>(
                    <>
                    <Calendar className={`${styles4.mobileNavLinkIconBase} ${isActive ?
                      styles4.mobileNavLinkIconInactive : styles4.mobileNavLinkIconInactive
                    }`}/>
                ...
                <NavLink to='/bookings' onClick={close} className={({isActive})=>`${styles4.mobileNavLinkBase} ${isActive ? styles4.mobileNavLinkActive : styles4.mobileNavLinkInactive}`}>
                  {({isActive})=>(
                    <>
                    <Ticket className={`${styles4.mobileNavLinkIconBase} ${isActive ?
                      styles4.mobileNavLinkIconInactive : styles4.mobileNavLinkIconInactive
                    }`}/>
