...
const AddPage = () => {
  ...
  function toggleCategory(cat) {
   ...
   // file helpers that renders the image uploaded by user.
 ...
 //it resets the field once the data gets submitted to server.
   function resetForm() {
    setMovieName("");
    setCategories([]);
    setPoster(null);
  ...
  // this function validates all teh field are filled or not with correct datails.
...
function Uploader({title,onFiles,items,remove,icon,updateMeta}){
    return (
        <div className={addMoviePageStyles.uploaderContainer}>
          ...
          <label className={addMoviePageStyles.uploaderAddButton}>+Add
...
//for latestTrailer we create NemedUplaoder
            ...
            items.map((it,idx)=>(
                <div key={idx} className={addMoviePageStyles.namedUploaderItem}>
                  ...
                  <div className="flex-1">
                      ...
                      placeholder='Name' className={addMoviePageStyles.namedUploaderInput} />
